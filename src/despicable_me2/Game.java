...
public class Game 
{
    ...
    public void createCharacter()
    {
        ...
        Character Professor_Nefario = new Character ("Professor Nefario", "Professor", laboratory);
        Character Martian1 = new Character ("Martian 1", "1", moon); 
        Character Martian2 = new Character ("Martian 2", "2", moon);
        Minion BadMinion = new Minion ("Bad Minion", "Minion who need to be cured", villa, false); 
    }
    /**
